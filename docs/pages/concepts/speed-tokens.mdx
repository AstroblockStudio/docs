...
<img src="/player-2.1.png" alt="speed and tokens visualization" style={{objectFit: "contain"}} />
...
<div className="flex flex-col gap-4 items-center justify-center border py-4 px-8 bg-blue-500/20">
